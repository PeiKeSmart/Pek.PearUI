	...
	function(exports) {
		...
		body.on("click", ".setting", function() {
			...
			const menuHtml =
				...
				'<div class="color-title">' + layuiMenuStyle + '</div>\n' +
			...
			const headHtml =
				'<div class="pearone-color">\n' +
				'<div class="color-title">' + layuiTopStyle + '</div>\n' +
				'<div class="color-content">\n' +
				'<ul>\n' + headItem + '</ul>\n' +
				'</div>\n' +
				'</div>';
			...
			let moreItem =
				'<div class="layui-form-item"><div class="layui-input-inline"><input type="checkbox" name="control" lay-filter="control" lay-skin="switch" lay-text="'+layuiOpen+'|'+layuiClose+'"></div><span class="set-text">'+layuiMenu+'</span></div>';

			moreItem +=
				'<div class="layui-form-item"><div class="layui-input-inline"><input type="checkbox" name="muilt-tab" lay-filter="muilt-tab" lay-skin="switch" lay-text="'+layuiOpen+'|'+layuiClose+'"></div><span class="set-text">'+layuiView+'</span></div>';

			moreItem +=
				'<div class="layui-form-item"><div class="layui-input-inline"><input type="checkbox" name="banner" lay-filter="banner" lay-skin="switch" lay-text="'+layuiOpen+'|'+layuiClose+'"></div><span class="set-text">'+layuiBanner+'</span></div>';

			moreItem +=
				'<div class="layui-form-item"><div class="layui-input-inline"><input type="checkbox" name="auto-head" lay-filter="auto-head" lay-skin="switch" lay-text="'+layuiOpen+'|'+layuiClose+'"></div><span class="set-text">'+layuiThroughColor+'</span></div>';

			moreItem +=
				'<div class="layui-form-item"><div class="layui-input-inline"><input type="checkbox" name="footer" lay-filter="footer" lay-skin="switch" lay-text="'+layuiOpen+'|'+layuiClose+'"></div><span class="set-text">'+layuiFooter+'</span></div>';

			const moreHtml = '<br><div class="pearone-color">\n' +
				'<div class="color-title">' + layuiMoreSettings + '</div>\n' +
				'<div class="color-content">\n' +
		...
		function buildColorHtml() {
			...
			return "<div class='select-color'><div class='select-color-title'>" + layuiThemeColor + "</div><div class='select-color-content'>" +
				colors + "</div></div>"
		}
