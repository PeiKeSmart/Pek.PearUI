...
(function(layui, window, factory) {
	...
	let v = '4.0.0.0910',
		...
		quickBtns = [
			{icon: 'xm-iconfont icon-quanxuan', name: layuiSelectAll, click: function(id, cm){
				cm.selectAll(id, true, true);
			}},
			{icon: 'xm-iconfont icon-qingkong', name: layuiClear, click: function(id, cm){
				cm.removeAll(id, true, true);
			}},
			{icon: 'xm-iconfont icon-fanxuan', name: layuiReverseSelection, click: function(id, cm){
				cm.reverse(id, true, true);
			}},
			{icon: 'xm-iconfont icon-pifu', name: layuiPeeling, click: function(id, cm){
				cm.skin(id);
			}}
		],
